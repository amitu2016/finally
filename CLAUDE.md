...
- Never commit `db/finally.db` or any `*.db` file — it is runtime data containing user accounts, portfolio, trades, and chat history. It is gitignored and must stay that way.