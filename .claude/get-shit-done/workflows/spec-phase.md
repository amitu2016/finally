...
```bash
INIT=$(node "/Users/amit/Developer/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/amit/Developer/Projects/finally/.claude/get-shit-done/templates/spec.md.
