...
```bash
INIT=$(node "/Users/amit/Developer/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/amit/Developer/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
