...
export function Header({ totalValue, cashBalance, status }: Props) {
  return (
    <header className="flex items-center justify-between border-b border-[#30363d] bg-[#161b22] px-4 py-3">
      <div className="flex items-baseline gap-2">
        <span className="text-lg font-bold tracking-tight text-[#ecad0a]">
          FinAlly
        </span>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="text-right">
          ...
          <div className="font-mono text-base text-[#e6edf3]">
